...
class CostAwarePolicy(PolicyBase):
    """Balances reuse, page size, and tier pressure when selecting victims."""
    ...
    def score_page(self, context: PolicyContext, page: KVPage, tier_name: str) -> float:
        ...
        return (
            ...
            - self.size_penalty * (page.size_bytes / 1024.0)
        )
