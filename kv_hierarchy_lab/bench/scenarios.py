...
def example_scenarios() -> list[Scenario]:
    """Returns a small matrix of benchmark scenarios."""
    ...
    return [
        Scenario("small_fp16_prefetch", smaller, "fp16", True),
        Scenario("small_int4_no_prefetch", smaller, "int4", False),
        Scenario("base_fp8_prefetch", base, "fp8", True),
    ]
